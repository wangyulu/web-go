...
import (
	...
	"github.com/wangyulu/web-go/framework/middleware/gin-swagger/example/basic/api"

	_ "github.com/wangyulu/web-go/framework/middleware/gin-swagger/example/basic/docs"
)
