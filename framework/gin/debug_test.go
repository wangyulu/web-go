...
func TestDebugPrintRoutes(t *testing.T) {
	...
	assert.Regexp(t, `^\[GIN-debug\] GET    /path/to/route/:param     --> (.*/vendor/)?github.com/wangyulu/web-go/framework/gin.handlerNameTest \(2 handlers\)\n$`, re)
}
...
func TestDebugPrintRouteFunc(t *testing.T) {
	...
	assert.Regexp(t, `^\[GIN-debug\] GET    /path/to/route/:param1/:param2           --> (.*/vendor/)?github.com/wangyulu/web-go/framework/gin.handlerNameTest \(2 handlers\)\n$`, re)
}
